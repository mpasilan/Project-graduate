...
<!-- Page Heading -->
 ...
 @if($message = Session::get('Success'))
                ...
                <tr>
                    ...
                    @php
                      ...
                      $balance = $total - $bfee;
                          ...
                          if($booking_status != 'pending' && $booking_status != 'Cancelled'){
    ...
    {{-- view --}}
        <div class="modal fade" id="ViewTrashed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <form method="POST" action="{{ route('restore.bo') }}">
              @method('POST')
                @csrf
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-info" id="continue" value="Restore Booking">
         </form>      
        </div>
